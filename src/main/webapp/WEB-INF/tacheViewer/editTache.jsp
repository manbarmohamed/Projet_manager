                ...
                <div class="formbold-form-wrapper">
                    <c:forEach var="task" items="${listoftask}">
                        <form action="editT" method="POST">
                            <div class="flex flex-wrap formbold--mx-3">
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        <label for="fName" class="formbold-form-label"> Tache Id </label>
                                        <input
                                                type="text"
                                                name="tacheId"
                                                id="fName"
                                                value="${task.getTacheId()}"
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                        ...
                                        <input
                                                ...
                                                name="description"
                                                id="lName"
                                                value="${task.getTacheDescription()}"
                                                class="formbold-form-input"
                                        />
                            ...
                            <div class="formbold-mb-5">
                                <label for="guest" class="formbold-form-label">Projet Id</label>
                                <input
                                        type="text"
                                        name="projetId"
                                        id="guest"
                                        value="${task.getProjectId()}" readonly
                                        class="formbold-form-input"
                                />
